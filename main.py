...
streamlit.write('made by Nao_kun from Revo-Tech')
streamlit.header('計算')
...
streamlit.title('')
streamlit.title('')
streamlit.header('Revo-Techとは')
streamlit.write('Revo-Techは学生エンジニアによって構成された開発チームです。本拠地は奈良県です。主な開発プロダクトはwebアプリケーションです。')
streamlit.header('Nao_kunの紹介')
streamlit.write('Nao_kunはRevo-Techのチームリーダーで主にPythonを使ったweアプリケーションの開発とサーバの構築・管理を行っています。HealthManagerはNao_kunによって開発されました。')